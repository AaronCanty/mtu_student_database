package ie.mtu.cs.oop.ass1.view;
...
import ie.mtu.cs.oop.ass1.controller.Controller;

public class View extends Application implements Serializable {
	...
	public void start(Stage primaryStage) {
		try {
			...
			primaryStage.setTitle("Student Record System MTU R00206055");
			primaryStage.show();
